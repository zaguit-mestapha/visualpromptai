  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 sm:px-6 pt-24 sm:pt-28 pb-16 sm:pb-20">
        <h1 className="text-3xl font-bold font-display sm:text-4xl text-foreground">Privacy Policy</h1>
        <p className="mt-2 text-sm text-muted">Last updated: April 2026</p>

        <div className="mt-8 space-y-8 text-muted leading-relaxed">
          <section>
            <h2 className="text-xl font-bold font-display text-foreground">1. Information We Collect</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-bold font-display text-foreground">2. Image Processing</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-bold font-display text-foreground">3. Cookies</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-bold font-display text-foreground">4. Third-Party Services</h2>
          ...
          <section>
            <h2 className="text-xl font-bold font-display text-foreground">5. Your Rights</h2>
          ...
          <section>
            <h2 className="text-xl font-bold font-display text-foreground">6. Data Security</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-bold font-display text-foreground">7. Contact</h2>
            <p className="mt-3">
