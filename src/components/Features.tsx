...
const features = [
  {
    ...
    description:
      "Drag-and-drop interface to build complex prompts with style blocks, subjects, lighting, and camera angles.",
    icon: (
  ...
  },
  {
    title: "Prompt Fixer",
    description:
      "Paste any rough prompt and get an optimized, model-specific version instantly. Free AI prompt fixer for Midjourney, DALL-E, Stable Diffusion, and Flux.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "AI-powered analysis rates your prompts for clarity, specificity, and predicted output quality before you generate.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    title: "A/B Testing",
    description:
      "Compare prompt variations side by side and iterate faster with visual diffs and generation previews.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  {
    title: "Multi-Model Export",
    description:
      "One prompt, every platform. Auto-convert syntax between Midjourney, DALL-E, Flux, and Stable Diffusion.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Browse and share community-curated prompt templates. Find inspiration and jumpstart your creative workflow.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
